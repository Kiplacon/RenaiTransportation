data:extend({
	...
	{ --------- Bounce plate entity --------------
		...
		name = "BouncePlate",
		icon = "__RenaiTransportation__/graphics/BouncePlate/PlateIconn.png",
		icon_size = 64,
		...
		picture = 
			{
				filename = "__RenaiTransportation__/graphics/BouncePlate/Plate.png",
				priority = "medium",
				width = 66,
				height = 76,
	...
	{ --------- bounce effect ----------
		...
		pictures =
			{
			  filename = "__RenaiTransportation__/graphics/BouncePlate/particle.png",
			  --width = 64,
			  --height = 64,
			  size = 32,
			  priority = "extra-high",
